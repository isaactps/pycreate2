...
if __name__ == "__main__":
	...
	while(True):
		...
		print("Enter (4) to start Turning left motion for 20 seconds")
		print("Enter (5) to start Turning right motion for 20 seconds")
		print("Enter (6) to start Moving forward for 40 inches")
		print("Enter (7) to start Moving backward for 40 inches")
		print("Enter (8) to start Turning left for 90 degrees")
		print("Enter (9) to start Turning right for 90 degrees")
